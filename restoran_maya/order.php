...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($_POST['kuantiti'] as $menu_id => $qty) {
        $qty = intval($qty);
        $remark = isset($_POST['remark'][$menu_id]) ? trim($_POST['remark'][$menu_id]) : '';
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Input catatan untuk setiap menu -->
                                <input type="text" name="remark[<?= $menu['id'] ?>]" class="form-control remark-input" placeholder="Catatan (contoh: kurang pedas, tanpa bawang)">
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
